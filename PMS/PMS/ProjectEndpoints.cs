...
namespace PMS
{
    public static class ProjectEndpoints
    {
        ...
        {
            projectsGroup.MapGet("projects", async ([AsParameters] SearchParameters searchParams,PMSDbContext dbContext, CancellationToken cancellationToken, LinkGenerator linkGenerator, Microsoft.AspNetCore.Http.HttpContext httpContext) => {
            ...
            projectsGroup.MapPost("projects", async ([Validate] CreateProjectDto createProjectDto, PMSDbContext dbContext, HttpContext httpContext, LinkGenerator linkGenerator) => {
